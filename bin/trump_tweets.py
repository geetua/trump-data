...
Adapted again from @sashaperigo:
https://github.com/sashaperigo/Trump-Tweets/blob/master/trump_tweets.py
"""
import urllib2
import csv
import json
...
class TwitterSearch:
    ...
    def execute_search(self, url):
        ...
        # If we get any exception, we sleep for our error delay, then make
        # another attempt
